...
function FriendStories({ stories }: { stories: any[] }) {
  return (
    <div>
...
function FriendSuggestions({ suggestions }: { suggestions: any[] }) {
  return (
    <div>
...
function TopFriends({ topFriends }: { topFriends: any[] }) {
  return (
    <div>
...
function FriendsFeed({ feed }: { feed: any[] }) {
  return (
    <div>
...
function FriendsFullList({ friends }: { friends: any[] }) {
