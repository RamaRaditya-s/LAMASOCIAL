...
(1, 'Elana Helen', 'https://images.pexels.com/photos/1674752/pexels-photo-1674752.jpeg', 'https://images.pexels.com/photos/26833720/pexels-photo-26833720.jpeg', 'On every peak, no matter how small, there is always room to stop, breathe, and look.', '2025-11-07 09:52:06'),
(2, 'Guest User', 'https://images.pexels.com/photos/1462980/pexels-photo-1462980.jpeg', '/post1.png', 'Where nature meets fantasy. Agapanthus blooms suspended in time, wrapped in bubbles and glowing with vibrant neon contrasts.\r\n\r\nMore than just a photo, it\'s liquid art.\r\n\r\nBlue, pink, and everything in between.', '2025-11-07 09:52:06'),
(3, 'Guest User', 'https://images.pexels.com/photos/1435517/pexels-photo-1435517.jpeg', '/post2.png', 'Peeking out from behind a purple leaf, observing the world. Nice to meet you, little guy!', '2025-11-07 09:52:06');

-- --------------------------------------------------------

--
-- Table structure for table `profilecard`
--
...
--
-- Dumping data for table `profilecard`
--

INSERT INTO `profilecard` (`id`, `username`, `name`, `surname`, `cover`, `avatar`, `followers`) VALUES
(1, 'mramar', 'Mr', 'Amar', '/dummycover.png', '/dummyavatar.png', 123);
...
INSERT INTO `userinformation` (`id`, `username`, `name`, `surname`, `avatar`, `cover`, `description`, `city`, `school`, `work`, `website`, `created_at`) VALUES
(1, 'tahuapa5', 'Tahu', 'Apa', 'user.png', 'dummycover.png', 'Penggemar tahu dan penikmat kopi', 'Bandung', 'Universitas Indonesia', 'Software Engineer', 'https://tahuapa5-portfolio.vercel.app', '2025-12-01 06:41:50');
...
--
-- Indexes for table `profilecard`
--
ALTER TABLE `profilecard`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `profilecard`
--
ALTER TABLE `profilecard`
